...
public class TinkerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "i am on onCreate string:" + getResources().getString(R.string.app_test_resource));
...
//                TinkerInstaller.loadLibraryFromTinker(getApplicationContext(), "assets/x86", "stlport_shared");
        ...
        buildInfoButton.setOnClickListener(v -> {
            // Toast.makeText(TinkerActivity.this, "===修复OK了=====", Toast.LENGTH_LONG).show();
    ...
    public boolean showInfo(Context context) {
        ...
        if (tinker.isTinkerLoaded()) {
            ...
            sb.append(String.format("[buildConfig VERSION_NAME] %s \n", BuildInfo.VERSION_NAME));
            sb.append(String.format("[buildConfig VERSION_CODE] %s \n", BuildInfo.VERSION_CODE));
